...
Была выполнена работа по тестированию функционала формы регистрации сайта kinomax.ru: <br>

<img src="https://i.ibb.co/kQrVGCc/2023-11-29-030222.jpg" alt="2023-11-29-030222" border="0">

## <a name="testings" />Тестовая документация и тестирование функционала регистрации
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5) и отчет о результатах тестирования  [test result report](#test-result-report)
